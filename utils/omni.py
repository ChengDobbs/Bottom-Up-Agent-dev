...
def get_yolo_model(model_path):
    from ultralytics import YOLO
    print("load som model from ", model_path)
...
def check_ocr_box(image_source: Union[str, Image.Image], display_img = True, output_bb_format='xywh', goal_filtering=None, text_threshold=0.9, use_paddleocr=True):
    if isinstance(image_source, str):
        image_source = Image.open(image_source)
