...
- Drag cards to the specific enemie(s) or yourself depending on the target.
...
You must follow the game rules and UI logic exactly. Use only available tools like `Click`, `Drag`. Always make progress toward winning the combat.
